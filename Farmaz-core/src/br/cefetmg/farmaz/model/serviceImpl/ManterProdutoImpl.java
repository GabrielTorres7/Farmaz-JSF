 ...
 * @author Gabriel
 */
public class ManterProdutoImpl extends UnicastRemoteObject implements ManterProduto{
    
    private final ProdutoDAOImpl produtoDAO;

    public ManterProdutoImpl(ProdutoDAOImpl produtoDAO) throws RemoteException {
        super();
