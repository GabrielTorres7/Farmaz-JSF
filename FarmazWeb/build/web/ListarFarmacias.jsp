...
<html>
    ...
    <body>
        ...
        <div class="container">   
            ...
            <form name="frmFarmacia" method='post' action='/farmaz/ServletWeb'>
                ...
                <table class="table table-striped"> 
                    ...
                    %>
                            ...
                            <tr>
                                <td>
                                    <a href="/FarmazWeb/ServletWeb?acao=MostrarMapa&DisponibilidadeId=<%=listDisponibilidade.get(i).getId()%>"><%=farmacia.getNome()%>
                                </td>
                                <td>
                                    <%=farmacia.getCnpj()%>
                                </td>
